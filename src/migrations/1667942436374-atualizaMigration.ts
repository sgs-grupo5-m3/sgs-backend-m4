...
export class atualizaMigration1667942436374 implements MigrationInterface {
    name = 'atualizaMigration1667942436374'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "doctor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "birth_date" date NOT NULL, "email" character varying(120) NOT NULL, "password" character varying(120) NOT NULL, "cpf" character varying(20) NOT NULL, "isDoctor" boolean NOT NULL DEFAULT true, "crm" character varying(20) NOT NULL, CONSTRAINT "UQ_e7ae9d234374b5e70c1d9180bd9" UNIQUE ("cpf"), CONSTRAINT "UQ_aab8f24bc311f018cf511577ac6" UNIQUE ("crm"), CONSTRAINT "PK_ee6bf6c8de78803212c548fcb94" PRIMARY KEY ("id"))`);
